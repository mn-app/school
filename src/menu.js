...
const MENU = {
	...
	'02': {
		breakfast: [
			'Помидор',
			'Тефтели "Натуральные" тушеные в сметанном соусе',
			'Картофельное пюре на молоке с маслом',
			'Хлеб пшеничный',
			'Чай с черной смородиной и медом'
		],
		lunch: [
			'Борщ с капустой и картофелем со сметаной',
			'Фрикадельки с говядиной с соусом томатным',
	...
	'03': {
		breakfast: ['Каша молочная с маслом', 'Бутерброд с маслом сыром', 'Чай с сахаром', 'Мандарин', 'Булочка с корицей (п/ф)'],
		lunch: ['Рассольник ленинградский со сметаной', 'Капуста тушеная с мясом птицы (филе)', 'Хлеб пшеничные', 'Компот вишневый']
	},
	'04': {
		breakfast: [
